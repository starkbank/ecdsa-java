...
public class CurveTest {
    ...
    public void testSupportedCurve() {
        ...
        PrivateKey privateKey1 = new PrivateKey(newCurve, null);
    ...
    public void testUnsupportedCurve() {
        ...
        String privateKeyPem = new PrivateKey(newCurve, null).toPem();
        // This should throw because brainpoolP256t1 is not registered
